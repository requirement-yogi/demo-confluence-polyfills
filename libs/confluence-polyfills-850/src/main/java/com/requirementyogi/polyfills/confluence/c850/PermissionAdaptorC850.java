package com.requirementyogi.polyfills.confluence.c850;
...
public class PermissionAdaptorC850 implements PermissionAdaptor {

    private final PermissionManager permissionManager;

    public PermissionAdaptorC850(PermissionManager permissionManager) {

package com.requirementyogi.polyfills.confluence.c720;
...
public class PermissionAdaptorC720 implements PermissionAdaptor {

    private final PermissionManager permissionManager;

    public PermissionAdaptorC720(PermissionManager permissionManager) {
